			      ...
			      <div class="box box-widget">
			        <div class="box-header with-border">
			          <div class="user-block">
			            ...
			            <span class="description"><%-- <fmt:formatDate pattern="dd-MM-yyyy HH:mm:ss" value="${question.creatAt}" /> --%>${question.creatAt}</span>
			          </div>
			          <!-- /.user-block -->
			        </div>
			        <!-- /.box-header -->
			                ...
			                <tbody>
			                  <c:forEach var="answer" items="${question.answers}">
			                    <tr>
			                      ...
			                      <td align="center">
			                        <a href="#" title="Delete answer" id="${question.questionId }" class="deleteAnswerBtn" data-id="${answer.answerId}">
