							...
							<div class="answercell post-layout--right">
							    ...
							    <div class="grid mb0 fw-wrap ai-start jc-end gs8 gsy">
							    	<div class="grid--cell mr16" style="flex: 1 1 100px;">
										...
										<div class="post-menu">
											<c:if test="${CURRENT_USER.userId eq question.user.userId and answer.best eq false}"><a href="#?qid=${question.questionId}&aid=${answer.answerId}&oid=${answer.user.userId}" class="best-answer btn btn-default" title="Chọn câu trả lời hữu ích">Chọn câu trả lời hữu ích</a></c:if>
										</div>                 
									</div>
