...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/resources/assets/css/admin-page.css">
  ...
  <script language="javascript" type="text/javascript" src="/resources/assets/js/admin-scripts.js"></script>
</head>
