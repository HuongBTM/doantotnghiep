	...
	<div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          ...
          <div style="padding-top: 5px; text-align: center"><a href="/expect/user/changeprofile">
            ...
            <c:forEach var="question" items="${user.questions}">
              ...
              <div class="post">
                <div class="user-block">
                  ...
                  <span class="username">
                    <a href="<c:url value="/expect/user/${user.userId}/info" />">${user.fullname}</a>
                ...
                <ul class="list-inline">
                  <li>
                    <a href="<c:url value="/expect/question/detail/${question.questionId}" />" class="link-black text-sm">
            ...
            <c:forEach var="answer" items="${user.answers}">
              ...
              <div class="post">
                <div class="user-block">
                  ...
                  <span class="username">
                    <a href="<c:url value="/expect/user/${answer.user.userId}" />">${answer.user.fullname}</a>
                    <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                  </span>
                  <span class="description">
                ...
                <ul class="list-inline">
                  <li>
                    <a href="<c:url value="/expect/question/detail/${answer.question.questionId}" />" class="link-black text-sm">
                      <i class="fa fa-share margin-r-5"></i> Xem chi tiết
                    </a>
                  </li>
                </ul>
          ...
          <div class="tab-pane" id="posts">
            <c:forEach var="post" items="${user.posts}">
              ...
              <div class="post">
                ...
                <ul class="list-inline">
                  <li>
                    <a href="<c:url value="/expect/post/detail/${post.postId}" />" class="link-black text-sm">
                      <i class="fa fa-share margin-r-5"></i> Xem chi tiết
                    </a>
                  </li>
                </ul>
